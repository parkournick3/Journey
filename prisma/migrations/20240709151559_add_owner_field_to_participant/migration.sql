...
INSERT INTO "new_participants" ("created_at", "email", "id", "is_confirmed", "name", "trip_id", "updated_at") SELECT "created_at", "email", "id", "is_confirmed", "name", "trip_id", "updated_at" FROM "participants";
